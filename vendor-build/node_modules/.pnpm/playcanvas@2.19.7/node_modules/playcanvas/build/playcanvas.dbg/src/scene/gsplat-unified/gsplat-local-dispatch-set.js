...
class GSplatLocalDispatchSet {
  ...
  constructor(device, pickMode) {
    ...
    /** @type {boolean} */
    __publicField(this, "pickMode");
    // Count compute caching: standard and fisheye variants, created lazily
    /** @type {Shader|null} */
    __publicField(this, "_countShader", null);
    /** @type {BindGroupFormat|null} */
    __publicField(this, "_countBindGroupFormat", null);
    /** @type {Compute|null} */
    __publicField(this, "_countCompute", null);
    /** @type {Shader|null} */
    __publicField(this, "_countShaderFisheye", null);
    /** @type {BindGroupFormat|null} */
    __publicField(this, "_countBindGroupFormatFisheye", null);
    /** @type {Compute|null} */
    __publicField(this, "_countComputeFisheye", null);
    /** @type {Compute} */
    __publicField(this, "placeEntriesCompute");
    /** @type {Compute} */
    __publicField(this, "largeSplatCompute");
    /** @type {Compute} */
    __publicField(this, "largePlaceEntriesCompute");
    /** @type {Compute} */
    __publicField(this, "classifyCompute");
    /** @type {Compute} */
    __publicField(this, "sortCompute");
    /** @type {Compute} */
    __publicField(this, "bucketSortCompute");
    /** @type {Compute} */
    __publicField(this, "copyCompute");
    /** @type {Compute} */
    __publicField(this, "chunkSortCompute");
    /** @type {Map<string, {shader: Shader, bindGroupFormat: BindGroupFormat, compute: Compute}>} */
    __publicField(this, "_rasterizeVariants", /* @__PURE__ */ new Map());
    /** @type {PrefixSumKernel} */
    __publicField(this, "prefixSumKernel");
    /** @type {StorageBuffer|null} */
    __publicField(this, "_tileSplatCountsBuffer", null);
    /** @type {StorageBuffer|null} */
    __publicField(this, "_smallTileListBuffer", null);
    /** @type {StorageBuffer|null} */
    __publicField(this, "_largeTileListBuffer", null);
    /** @type {StorageBuffer|null} */
    __publicField(this, "_largeTileOverflowBasesBuffer", null);
    /** @type {StorageBuffer|null} */
    __publicField(this, "_rasterizeTileListBuffer", null);
    /** @type {StorageBuffer|null} */
    __publicField(this, "_tileListCountsBuffer", null);
    /** @type {StorageBuffer|null} */
    __publicField(this, "_chunkRangesBuffer", null);
    /** @type {StorageBuffer|null} */
    __publicField(this, "_totalChunksBuffer", null);
    /** @type {StorageBuffer|null} */
    __publicField(this, "_chunkSortIndirectBuffer", null);
    /** @type {number} */
    __publicField(this, "_allocatedTileCapacity", 0);
    /** @type {Texture|null} Color mode output */
    __publicField(this, "outputTexture", null);
    /** @type {Texture|null} Pick mode: splat ID output (r32uint) */
    __publicField(this, "pickIdTexture", null);
    /** @type {Texture|null} Pick mode: depth output (rgba16float) */
    __publicField(this, "pickDepthTexture", null);
    this.device = device;
